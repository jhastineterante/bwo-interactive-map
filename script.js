...
// FIXED: Hover effect that prevents infinite loop
function setupPinHoverEffect() {
    ...
    allPins.forEach(pin => {
        pin.addEventListener('mouseenter', function() {
            ...
            // Only move if not already the last child (on top)
            if (parent && parent.lastElementChild !== this) {
...
// Helper function to set the active pin and bring it to the front
